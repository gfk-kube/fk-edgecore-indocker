...
alma)
    ...
    args="--build-arg FULL=/.."
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-system/Dockerfile.alma . 
    ;;
alma-sdk)
    ...
    plat="--platform linux/amd64,linux/arm64" ##,linux/arm
    args="--build-arg FULL=/.."
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-system/Dockerfile.alma-sdk . 
    ;;
ansible)
    ...
    plat="--platform linux/amd64,linux/arm64" ##,linux/arm
    args="--build-arg FULL=/.."
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-ansible/Dockerfile.ansible . 
    ;;
ansible-mitogen)
    ...
    args="--build-arg FULL=/.."
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-ansible/Dockerfile.ansible-mitogen . 
    ;;
ansible-mitogen-alpine38)
    ...
    plat="--platform linux/amd64,linux/arm64 --provenance=false" ##,linux/arm
    args="--build-arg FULL=/.."
    # docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-ansible/oth/Dockerfile.ansible-mtg-alpine39-ansi28py2 .
    ...
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-ansible/Dockerfile.ansible-mtg-alpine314-ansi210py3 . #org\'s 143M? (ansi> ansi-base)
    # docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-ansible/Dockerfile.ansible-mtg-alpine314-ansi213py3 . #(ansi> ansi-base> ansi-core)
    ;;
ansible-ubt2004)
    ...
    plat="--platform linux/amd64,linux/arm64" ##,linux/arm
    args="--build-arg FULL=/.."
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f imgs/env-ansible/oth/Dockerfile.ansible-mtg-ubt2004 . 
    ;;
builder)
...
*)
    ...
    docker buildx build $cache $plat $args --push -t $repo/$ns/$img -f _ex/edge-kind/Dockerfile.lite . 
